...
public class AdvancedActivity extends AppCompatActivity {
    ...
    ImageView i11,i12,i13,i14,i21,i22,i23,i24,i31,i32,i33,i34,i41,i42,i43,i44,i51,i52,i53,i54;

    // array of images
    Integer cardsArray[] = { 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 201, 202, 203, 204, 205, 206, 207, 208, 209, 220};

    // images
    int image101, image102, image103, image104, image105, image106, image107, image108, image109, image110, image201, image202, image203, image204, image205, image206, image207, image208, image209, image220;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.advanced_activity_scores);
    ...
    private void doStuff(ImageView i, int card ){
        if(cardsArray[card] == 101){
            ...
            i.setImageResource(image109);
        }
        else if(cardsArray[card] == 110){
            i.setImageResource(image110);
        }
            ...
            i.setImageResource(image209);
        }
        else if(cardsArray[card] == 220){
            i.setImageResource(image220);
        }
    ...
    private void calculate(){
        if(firstCard == secondCard){
            ...
            i51.setImageResource(R.drawable.joker);
            i52.setImageResource(R.drawable.joker);
            i53.setImageResource(R.drawable.joker);
            i54.setImageResource(R.drawable.joker);
    ...
    private void checkEnd(){
        if(i11.getVisibility() == View.INVISIBLE && i12.getVisibility() == View.INVISIBLE && i13.getVisibility() == View.INVISIBLE && i14.getVisibility() == View.INVISIBLE &&
                ...
                i51.getVisibility() == View.INVISIBLE && i52.getVisibility() == View.INVISIBLE && i53.getVisibility() == View.INVISIBLE && i54.getVisibility() == View.INVISIBLE){

            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AdvancedActivity.this);
    ...
    private void frontOfCardResources(){
        ...
        image109 = R.drawable.img9;
        image110 = R.drawable.img10;
        ...
        image209 = R.drawable.img209;
        image220 = R.drawable.img220;
    }
