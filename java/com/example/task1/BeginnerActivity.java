...
public class BeginnerActivity extends AppCompatActivity {
    ...
    ImageView i11,i12,i13,i14,i21,i22,i23,i24,i31,i32,i33,i34;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.beginner_activity_scores);
    ...
    private void checkEnd(){
        if(i11.getVisibility() == View.INVISIBLE && i12.getVisibility() == View.INVISIBLE && i13.getVisibility() == View.INVISIBLE && i14.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(BeginnerActivity.this);
